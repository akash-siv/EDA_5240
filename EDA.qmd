...
```
Ok now we can see that some of the location names have some additional datas and typos and with different cases. Let's clean this.
...
Now we can apply it for entire dataframe.
